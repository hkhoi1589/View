...
function PersonHeader({
	...
	useEffect(() => {
		if (
			...
			setSelectedCover(coverPicture);
			setSelectedProfile(profilePicture);
		}
	}, [id, profilePicture, username, email, desc, coverPicture]);
				...
				<div className='person-header_img'>
					<div className='person-header_cover'>
						{isLoading ? (
							...
							coverPicture && <img src={coverPicture} alt='cover.png' />
						)}
					</div>
				...
				<div className='container'>
					<Modal.Body>
						...
						<div className='flex-between'>
							<div className='person-header_preview'>
								<Modal.UploadFile
