...
import { SET_RANDOM_FRIEND, RandomFriend } from './reducers/userReducer';
import { CLEAR_POSTS, GetAllPosts, SET_POSTS } from './reducers/postReducer';
...
function App() {
	...
	useEffect(() => {
		async function FirstLoad() {
			const result = await dispatch(GetAllPosts(1));
